...
<head>
  ...
  <title>iRacing Team Tracker — CSV Test</title>
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    @media (max-width: 1100px) { .header-grid { grid-template-columns: repeat(2, minmax(0,1fr)); } .grid { grid-template-columns: 1fr; } }
  </style>
</head>
<body>
<div class="wrap">
  <div class="topbar">
    <div><h1 class="title" id="title">iRacing Team Tracker</h1><div class="subtitle">CSV replay mode using reported session fields</div></div>
  ...
  <div class="header-grid">
    ...
    <div class="card"><div class="label">Stops Remaining</div><div class="big" id="stopsRemainingHeader">-</div><div class="small">Using reported + recalculated data</div></div>
